...
$result = $conn->query($sql);
   ...
   echo  "<div class='row'>
    ...
    <div class='underline'></div>
                        ...
                        while($row= $result->fetch_assoc()){
                          ...
                          $sql2 = "SELECT medium from paintings where paint_id=$row[art_id]";
      ...
      <div class='card'>
       <img src='pic3.jpeg' alt='card-1' class='card-img-top'>
      <div class='card-body'>
       <h5>".$r2['paint_id']."</h5><h6>".$r3['price']."</h6><h6>".$r2['medium']."</h6></div></div>   </div>";
                      #echo """</td>
                       #     <td>""</td>
                        #    <td>""</td>";
   ...
   $sql = "SELECT * from art where type='P'";
                $result = $conn->query($sql);
   if ($result->num_rows > 0) {
   echo  "<h1 style='margin-top:250px;margin-left:100px'>Paintings</h1>
                        ...
                        while($row= $result->fetch_assoc()){
                          ...
                          $sql2 = "SELECT * from paintings where paint_id=$row[art_id]";
